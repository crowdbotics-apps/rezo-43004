"""
Django settings for rezo_43004 project.
...
WSGI_APPLICATION = 'rezo_43004.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "rezo_43004 API",
    "DESCRIPTION": "API documentation for rezo_43004 App",
    "VERSION": "v1",
}
